...
<div style="display:grid;place-items:center;min-height:62vh;text-align:center;padding:32px;background:#000;">
  <div>
        <h1 style="font-size:clamp(24px,4.5vw,64px);line-height:.95;margin:0;color:#fff;text-align:center;">
          Deliver brilliance. Smash boundaries.<br/>The world is on your feet.
        </h1>
    <p style="max-width:720px;margin:16px auto 0;color:#bbb;font-size:clamp(14px,2vw,18px);">
      Futuristic soccer cleats—sketches, specs and immersive presentation. Designed for speed, control and traction.
    </p>
  </div>
</div>
